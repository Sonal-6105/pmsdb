...
<html lang="en">
<head>
	<title>Financial Progress| Project Management System</title>
	<meta charset="UTF-8">
...
<div class="col-md-12">
			...
			<div class="card">
			   ...
			   <p>
							...
							<div class="col-md-3"><label for="project_name" class="">Project Name:</label></div>
								<div class="col-md-9" >
									<div class="position-relative form-group" id = "col1">
										...
										<textarea class="form-control" name="project_name" id="project_name" type="text" rows="5"  readonly><?php ?></textarea>
									</div>
								</div>
			    ...
			    <div class="form-row">
							<div class="col-md-3"><label for="fund_type" class="">Fund Type/ Mode:</label></div>
								<div class="col-md-3" >
									<div class="position-relative form-group" id = "col2">
										<input name="fund_type" id="fund_type" type="text" class="form-control" value="<?php ?>" readonly  />
										
									</div>
								</div>
							<div class="col-md-3"><label for="budget_head" class="">Budget Head:</label></div>
								<div class="col-md-3" >
									<div class="position-relative form-group" id = "col2">
										<input name="budget_head" id="budget_head" type="text" class="form-control" value="<?php ?>" readonly  />
				...
				<div class="form-row">
							<div class="col-md-3"><label for="estimated_cost" class="">Estimated Cost(in Cr.):</label></div>
								<div class="col-md-3" >
									<div class="position-relative form-group" id = "col1">
										<input name="estimated_cost" id="estimated_cost" type="text" class="form-control" value="<?php ?>" readonly  />
									</div>
								</div>
							<div class="col-md-3"><label for="awarded_cost" class="">Awarded Cost(in Cr.):</label></div>
								<div class="col-md-3" >
									<div class="position-relative form-group" id = "col1">
										<input name="awarded_cost" id="awarded_cost" type="text" class="form-control" value="<?php ?>" readonly  />
									</div>
								</div>
				...
				<div class="form-row">
							<div class="col-md-3"><label for="cleared_amount" class="">Cleared Amount:</label></div>
								<div class="col-md-3">
									<div class="position-relative form-group" id = "col2">								
										<input name="cleared_amount" id="cleared_amount" type="text" class="form-control" value="<?php ?>" readonly  />
											
									</div>
								</div>	
							<div class="col-md-3"><label for="outstanding_amount" class="">Outstanding Amount:</label></div>
								<div class="col-md-3" >
									<div class="position-relative form-group" id = "col1">
										<input name="outstanding_amount" id="outstanding_amount" type="text" class="form-control" value="<?php ?>" readonly  />
									</div>
								</div>
				...
				<div class="form-row">
							<div class="col-md-3"><label for="project_manager" class="">Project Manager:</label></div>
								<div class="col-md-3">
									<div class="position-relative form-group" id = "col2">								
										<input name="project_manager" id="project_manager" type="text" class="form-control" value="<?php ?>" readonly  />
							...
							<div class="col-md-3"><label for="contact_no" class="">Contact No of Project Manager:</label></div>
								<div class="col-md-3" >
									<div class="position-relative form-group" id = "col1">
										<input name="contact_no" id="contact_no" type="text" class="form-control" value="<?php ?>" readonly  />
									</div>
								</div>
