...
<html lang="en">
<head>
	<title>New Scheme | Project Management System </title>
	<meta charset="UTF-8">
		...
		<div class="p-2">
			<div class="wrapper">
				<div class="text-info font-weight-bold" >
					<h5>Enter New Scheme Details:</h5>
				</div>
			</div>
		</div>
...
<div class="col-md-12">
			...
			<div class="card">
				...
				<div class="card-body ">
               <form class="" method="post" enctype="multipart/form-data" action="pms-new-scheme.php"> 
			  
			   <div class="form-row">
							<div class="col-md-3"><label for="scheme_name" class="">Scheme Name:</label></div>
								<div class="col-md-6" >
									<div class="position-relative form-group" id = "col1">
										<input name="scheme_name" id="scheme_name" type="text" class="form-control required control-label"  autocomplete="off" />
									</div>
								</div>
							...
							<div class="col-md-3"><label for="objective" class="">Brief-Objective(Scope and Funding):</label></div>
								<div class="col-md-6" >
									<div class="position-relative form-group" id = "col12">
										...
										<textarea class="form-control" name="objective" id="objective" type="text" rows="6" autocomplete="off"></textarea>
									</div>
								</div>
							...
							<div class="col-md-3"><label for="scheme_head" class="">Executive Head:</label></div>
								<div class="col-md-3" >
									<div class="position-relative form-group" id = "col3">
										<input name="scheme_head" id="scheme_head" type="text" class="form-control" autocomplete="off"/>
									</div>
								</div>
							...
							<div class="col-md-3"><label for="sanctioned_cost" class="">Sanctioned Cost(In Cr.):</label></div>
								<div class="col-md-3">
									<div class="position-relative form-group" id = "col9">								
										<input name="sanctioned_cost" id="sanctioned_cost" type="text" class="form-control" autocomplete="off" />
				...
				<div class="form-row">
								...
								<div class="col-md-6" >
									<div class="position-relative form-group" id = "col12">
										...
										<textarea class="form-control" name="funding_mechanism" id="funding_mechanism" type="text" rows="5" autocomplete="off"></textarea>
									</div>
								</div>
							...
							<div class="col-md-3"><label for="target_date" class="">Target Date of Completion:</label></div>
								<div class="col-md-3" >
									<div class="position-relative form-group" id = "col11">
										<input name="target_date" id="target_date" type="text" class="form-control " autocomplete="off" />
									</div>
								</div>
							<div class="col-md-3"><label for="expd_till_date" class="">Expenditure Till Date(In Cr.):</label></div>
								<div class="col-md-3">
									<div class="position-relative form-group" id = "col9">								
										<input name="expd_till_date" id="expd_till_date" type="text" class="form-control" autocomplete="off" />
							...
							<div class="col-md-3"><label for="progress" class="">Status:</label></div>
								<div class="col-md-6" >
									<div class="position-relative form-group" id = "col12">
										...
										<textarea class="form-control" name="progress" id="progress" type="text" rows="5" autocomplete="off"></textarea>
									</div>
								</div>
				 ...
				 <div class="m-t-20 d-flex justify-content-center" style="text-align:center">
								...
								<?php 
                                    if(isset($_POST['submit'])){
										...
										//echo('hello');
                                        if(createScheme($_POST['scheme_name'], $_POST['objective'],$_SESSION['wing_id'], $_POST['scheme_head'], $_POST['estimated_cost'], 
                                        $_POST['sanctioned_cost'], $_POST['funding_mechanism'], $_POST['target_date'], $_POST['expd_till_date'], $_POST['progress'], 
                                        $_POST['remarks'], $_SESSION['name'])){
											   ...
											   Swal.fire(
												  {
													icon: 'success',
													title: 'Success',
													text: 'Scheme details have been succesfully added!',
