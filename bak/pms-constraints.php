...
<html lang="en">
<head>
	<title>Hindrances | Project Management System</title>
	<meta charset="UTF-8">
...
<div class="col-md-12">
			...
			<div class="card">
			   ...
			   <div class="form-row">
							<div class="col-md-3"><label for="hindrance_nature" class="">Nature of Hindrance:</label></div>
								<div class="col-md-3" >
									<div class="position-relative form-group" id = "col2">
										<input name="hindrance_nature" id="hindrance_nature" type="text" class="form-control" value="<?php ?>" readonly  />
										
									</div>
								</div>
							<div class="col-md-3"><label for="occurence_date" class="">Date of Occurence:</label></div>
								<div class="col-md-3" >
									<div class="position-relative form-group" id = "col2">
										<input name="occurence_date" id="occurence_date" type="text" class="form-control" value="<?php ?>" readonly  />
				...
				<div class="form-row">
							<div class="col-md-3"><label for="hindrance_details" class="">Hindrance Details:</label></div>
								<div class="col-md-9" >
									<div class="position-relative form-group" id = "col1">
										
										<textarea class="form-control" name="hindrance_details" id="hindrance_details" type="text" rows="5"  readonly><?php ?></textarea>
									</div>
								</div>
				...
				<div class="form-row">
							<div class="col-md-3"><label for="action_taken" class="">Remarks/ Action Taken:</label></div>
								<div class="col-md-9" >
									<div class="position-relative form-group" id = "col1">
										
										<textarea class="form-control" name="action_taken" id="action_taken" type="text" rows="5"  readonly><?php ?></textarea>
									</div>
								</div>
