...
<nav class="navbar navbar-expand-sm bg-light fixed-top shadow-sm">
    ...
    <div class="navbar-collapse justify-content-end">
		<ul class="navbar-nav hvr-underline-from-center p-r-5">
			<li class="nav-item">
			<a class="nav-link current-page" href="pms-dashboard.php">Dashboard</a>
			</li>
		</ul>
...
<div class="container-fluid p-l-50 p-r-50">
	<div class="row " >
		  <div class="col-auto mr-auto " style="width:600px">
			...
			<span class="welcome-heading">Welcome ! <?php echo($_SESSION['name']); ?> .</span>
		  </div>
			...
			<div class="card text-center">
				...
				<div class="card-body" id="Grid">
					...
					$id=sourceCount();
						if($id ==0){
							echo('
							<lottie-player src="vendor/lottie/70332-no-data-animation.json"
									background="transparent"  speed="1"  style="width: 300px; height: 230px; margin-left: 35%;"  loop  autoplay></lottie-player>
							...
							while($row = mysqli_fetch_assoc($table_data)){
								echo('<tr>');
								echo('<td>'.$row_id.'</td>');
								if($row['project_phase']== '0'){
									 echo ('<td id="stdname" style="text-align:left;vertical-align:middle">'.$row['project_name'].'</td>'); 
								  }
								else{
								  echo('<td id="stdname" style="text-align:left;vertical-align:middle">'.$row['project_name'].' Phase -<b>'.$row['project_phase'].'</b></td>');}
