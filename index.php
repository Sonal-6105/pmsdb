		...
		<div class="container-login100" id="grad1" >
			<div class="wrap-login100" >
				<form class="login100-form validate-form" method="post" action="index.php">
					...
					<b>e -</b><b style="font-size: 35px;">N</b>IRMAN
						
						
					</span>
					<span class="login100-form-title p-b-20" style="font-size: 10px;color: blue;">
						"New and In-Progress Project Resource Monitoring"
					</span>
						...
						<?php
							...
							if(count($user_details) == 1){
								...
								if(isValidUser($_POST['username'],$_POST['pass'])){
									...
									$_SESSION['parent_id'] = $user_details[0]['parent_id'];
									...
									if(($user_details[0]['type'] == "U")||($user_details[0]['type'] == "Z")){
										//print_r("sonali");	
										header("Location:pms-manager.php");
										exit;
									}
